...
// const files = require('../../Files/vishwash-dc50c-firebase-adminsdk-az1im-4587f6cdcc.json')
...
// admin.initializeApp({
//     credential: admin.credential.cert(files)
// });
...
// funcation for set notification
async function setNotification(name) {
    try {
        const newNotification = new Notification({
            title: 'New Form Created',
            message: `A new form has been created by ${name}`
        });
...
route.post('/create', authMiddleWare, upload.array('images'), async (req, res) => {
    ...
    try {
        ...
        await setNotification(name)

        // const message = {
        //     notification: {
        //         title: 'New Form Created',
        //         body: `A new form has been created by ${name}`
        //     },
